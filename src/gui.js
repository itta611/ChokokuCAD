...
export const startAddBtn = document.querySelector('#copy-step1 .btn');
export const applyCopyModelBtn = document.querySelector('#copy-step2 .btn');
export const settingAddStep1 = document.querySelector('#copy-step1');
export const settingAddStep2 = document.querySelector('#copy-step2');
