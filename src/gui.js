...
export const copyBtn = document.querySelector('#copy-step1 .btn');
export const copyApplyBtn = document.querySelector('#copy-step2 .btn');
export const settingCopyStep1 = document.querySelector('#copy-step1');
export const settingCopyStep2 = document.querySelector('#copy-step2');
